...
//making an object. I herby dub thee "spot"
function Spot(i,j){
  ...
  if(random(1)<0.4)//change obstacle probability here
  {
    this.wall = true; //Randomly generates obstacle.*cue Pink Floyd*
  }
...
// add neighbours
  ...
  openSet.push(start); //this is where you start the algo, so push it onto openSet first
